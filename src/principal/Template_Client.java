...
public class Template_Client {
	...
	private void Valider(ActionEvent e) {
		...
		try {
			...
			JOptionPane.showConfirmDialog(null, "Enregistrement non effectué ","Erreur - Adresse",JOptionPane.DEFAULT_OPTION);
		}
		...
		try {
			...
			JOptionPane.showConfirmDialog(null, "Enregistrement non effectué ","Erreur - Personne",JOptionPane.DEFAULT_OPTION);	
		}
		try {
